...
Interactive SVG map of Greece with 14 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/greece.json
```

```tsx
'use client'

import { GreeceMap } from '@/components/shadcnmaps/maps/greece'
