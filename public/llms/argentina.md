...
Interactive SVG map of Argentina with 24 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { ArgentinaMap } from '@/components/shadcnmaps/maps/argentina'
