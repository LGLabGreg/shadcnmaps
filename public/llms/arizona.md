...
Interactive SVG map of Arizona with 15 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { ArizonaMap } from '@/components/shadcnmaps/maps/arizona'
