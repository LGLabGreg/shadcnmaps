...
Interactive SVG map of Vermont with 14 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/vermont.json
```

```tsx
'use client'

import { VermontMap } from '@/components/shadcnmaps/maps/vermont'
