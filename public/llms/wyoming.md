...
Interactive SVG map of Wyoming with 23 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { WyomingMap } from '@/components/shadcnmaps/maps/wyoming'
