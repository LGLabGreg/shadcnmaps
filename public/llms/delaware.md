...
Interactive SVG map of Delaware with 3 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/delaware.json
```

```tsx
'use client'

import { DelawareMap } from '@/components/shadcnmaps/maps/delaware'
