...
Interactive SVG map of Louisiana with 64 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { LouisianaMap } from '@/components/shadcnmaps/maps/louisiana'
