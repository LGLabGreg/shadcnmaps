...
Interactive SVG map of London Boroughs with 33 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { LondonBoroughsMap } from '@/components/shadcnmaps/maps/london-boroughs'
