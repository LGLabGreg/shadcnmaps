...
Interactive SVG map of France with 13 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn add https://shadcnmaps.com/r/france-map.json
```

```tsx
'use client'

import { FranceMap } from '@/components/shadcnmaps/maps/france-map'
