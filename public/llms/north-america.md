...
Interactive SVG map of North America with 29 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { NorthAmericaMap } from '@/components/shadcnmaps/maps/north-america'
