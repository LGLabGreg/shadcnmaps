...
Interactive SVG map of New York with 62 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { NewYorkMap } from '@/components/shadcnmaps/maps/new-york'
