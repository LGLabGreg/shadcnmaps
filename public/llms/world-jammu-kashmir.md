...
Interactive SVG map of World (Jammu & Kashmir) with 257 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { WorldJammuKashmirMap } from '@/components/shadcnmaps/maps/world-jammu-kashmir'

export default function SimpleExample() {
  return <WorldJammuKashmirMap />
}
```
