...
Interactive SVG map of New Zealand with 19 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/new-zealand.json
```

```tsx
'use client'

import { NewZealandMap } from '@/components/shadcnmaps/maps/new-zealand'
