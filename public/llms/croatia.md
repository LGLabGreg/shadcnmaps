...
Interactive SVG map of Croatia with 21 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { CroatiaMap } from '@/components/shadcnmaps/maps/croatia'
