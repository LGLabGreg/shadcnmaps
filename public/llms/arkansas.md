...
Interactive SVG map of Arkansas with 75 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { ArkansasMap } from '@/components/shadcnmaps/maps/arkansas'
