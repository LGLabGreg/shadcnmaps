...
Interactive SVG map of Estonia with 15 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/estonia.json
```

```tsx
'use client'

import { EstoniaMap } from '@/components/shadcnmaps/maps/estonia'
