...
Interactive SVG map of Uruguay with 19 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { UruguayMap } from '@/components/shadcnmaps/maps/uruguay'
