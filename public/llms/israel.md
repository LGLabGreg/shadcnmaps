...
Interactive SVG map of Israel with 6 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { IsraelMap } from '@/components/shadcnmaps/maps/israel'
