...
Interactive SVG map of France Départements with 101 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { FranceDepartementsMap } from '@/components/shadcnmaps/maps/france-departements'
