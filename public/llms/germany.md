...
Interactive SVG map of Germany with 16 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/germany.json
```

```tsx
'use client'

import { GermanyMap } from '@/components/shadcnmaps/maps/germany'
