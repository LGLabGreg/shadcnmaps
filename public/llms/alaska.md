...
Interactive SVG map of Alaska with 29 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { AlaskaMap } from '@/components/shadcnmaps/maps/alaska'
