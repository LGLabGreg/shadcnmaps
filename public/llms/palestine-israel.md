...
Interactive SVG map of Palestine & Israel with 23 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { PalestineIsraelMap } from '@/components/shadcnmaps/maps/palestine-israel'

export default function SimpleExample() {
  return <PalestineIsraelMap />
}
```
