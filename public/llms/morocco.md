...
Interactive SVG map of Morocco with 16 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { MoroccoMap } from '@/components/shadcnmaps/maps/morocco'
