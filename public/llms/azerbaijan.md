...
Interactive SVG map of Azerbaijan with 78 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { AzerbaijanMap } from '@/components/shadcnmaps/maps/azerbaijan'

export default function SimpleExample() {
  return <AzerbaijanMap />
}
```
