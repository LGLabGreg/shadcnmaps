...
Interactive SVG map of Michigan with 83 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { MichiganMap } from '@/components/shadcnmaps/maps/michigan'
