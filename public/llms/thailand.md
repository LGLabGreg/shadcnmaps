...
Interactive SVG map of Thailand with 77 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { ThailandMap } from '@/components/shadcnmaps/maps/thailand'
