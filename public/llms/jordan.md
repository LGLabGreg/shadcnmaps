...
Interactive SVG map of Jordan with 12 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { JordanMap } from '@/components/shadcnmaps/maps/jordan'
