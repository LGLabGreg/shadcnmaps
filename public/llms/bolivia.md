...
Interactive SVG map of Bolivia with 9 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { BoliviaMap } from '@/components/shadcnmaps/maps/bolivia'
