...
Interactive SVG map of Australia with 8 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { AustraliaMap } from '@/components/shadcnmaps/maps/australia'
