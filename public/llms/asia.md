...
Interactive SVG map of Asia with 53 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/asia.json
```

```tsx
'use client'

import { AsiaMap } from '@/components/shadcnmaps/maps/asia'
