...
Interactive SVG map of Algeria with 48 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/algeria.json
```

```tsx
'use client'

import { AlgeriaMap } from '@/components/shadcnmaps/maps/algeria'
