...
Interactive SVG map of United Arab Emirates with 9 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { UaeMap } from '@/components/shadcnmaps/maps/uae'
