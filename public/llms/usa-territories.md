...
Interactive SVG map of USA Territories with 60 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { UsaTerritoriesMap } from '@/components/shadcnmaps/maps/usa-territories'
