...
Interactive SVG map of Oman with 11 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { OmanMap } from '@/components/shadcnmaps/maps/oman'
