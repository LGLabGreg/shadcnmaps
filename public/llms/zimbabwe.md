...
Interactive SVG map of Zimbabwe with 10 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/zimbabwe.json
```

```tsx
'use client'

import { ZimbabweMap } from '@/components/shadcnmaps/maps/zimbabwe'
