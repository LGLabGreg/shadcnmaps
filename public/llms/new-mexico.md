...
Interactive SVG map of New Mexico with 33 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { NewMexicoMap } from '@/components/shadcnmaps/maps/new-mexico'
