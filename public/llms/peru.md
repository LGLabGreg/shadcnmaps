...
Interactive SVG map of Peru with 26 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { PeruMap } from '@/components/shadcnmaps/maps/peru'
