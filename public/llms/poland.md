...
Interactive SVG map of Poland with 16 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { PolandMap } from '@/components/shadcnmaps/maps/poland'
