...
Interactive SVG map of Angola with 18 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { AngolaMap } from '@/components/shadcnmaps/maps/angola'
