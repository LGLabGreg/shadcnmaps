...
Interactive SVG map of USA & Canada with 63 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { UsaCanadaMap } from '@/components/shadcnmaps/maps/usa-canada'
