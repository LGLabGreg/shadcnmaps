...
Interactive SVG map of New York City Boroughs with 6 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.
...
import { NewYorkCityBoroughsMap } from '@/components/shadcnmaps/maps/new-york-city-boroughs'

export default function SimpleExample() {
  return <NewYorkCityBoroughsMap />
}
```
