...
Interactive SVG map of Italy with 21 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/italy.json
```

```tsx
'use client'

import { ItalyMap } from '@/components/shadcnmaps/maps/italy'
