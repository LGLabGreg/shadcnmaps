...
Interactive SVG map of Paraguay with 18 regions. Supports click, hover, keyboard navigation, tooltips, and custom markers.

## Installation

```bash
npx shadcn@latest add https://shadcnmaps.com/r/paraguay.json
```

```tsx
'use client'

import { ParaguayMap } from '@/components/shadcnmaps/maps/paraguay'
